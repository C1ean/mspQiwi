...
$_lang['setting_ms2_mspqiwi_shopKey_desc'] = 'Qiwi Visa Wallet password';


$_lang['setting_ms2_mspqiwi_lifetime'] = 'Bills lifetime';
...
$_lang['setting_ms2_mspqiwi_successId'] = 'Qiwi successfull page ID';
$_lang['setting_ms2_mspqiwi_successId_desc'] = 'ID for forward user after payment done';

$_lang['setting_ms2_mspqiwi_failureId'] = 'Qiwi failures payment';
$_lang['setting_ms2_mspqiwi_failureId_desc'] = 'ID for forward user after cancel payment';
